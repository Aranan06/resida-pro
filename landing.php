...
<footer class="py-4 border-top bg-white">
  <div class="container d-flex flex-wrap gap-3 justify-content-between small muted">
    ...
    <span class="d-flex gap-3 align-items-center"><a href="blog.php" class="link-secondary text-decoration-none">Blog</a><a href="kvkk.php" class="link-secondary text-decoration-none">KVKK</a><a href="index.php" class="link-secondary text-decoration-none">Giriş</a><?php $ig=$T('social_instagram','https://instagram.com/residapro'); if($ig): ?><a href="<?= htmlspecialchars($ig) ?>" target="_blank" title="Instagram'da takip edin" style="color:#E1306C;font-size:1.15rem"><i class="fa-brands fa-instagram"></i></a><?php endif; ?></span>
  </div>
</footer>
