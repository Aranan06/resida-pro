...
$isSubscriptionActive = (bool)$pdo->query("SELECT 1 FROM site_subscriptions WHERE site_id=$mySiteId AND status='active' AND current_period_end >= CURDATE() LIMIT 1")->fetchColumn();
...
<header class="topbar d-flex justify-content-between align-items-center">
  <div class="d-flex align-items-center">
    ...
    <span class="topbar-title"><i class="fa-solid fa-<?php
      $icons=['dashboard'=>'gauge-high','residents'=>'people-roof','dues'=>'coins','expenses'=>'receipt','announcements'=>'bullhorn','events'=>'calendar-days'];
      echo $icons[$page]??'gauge-high';
    ?> me-2 text-accent"></i><?php
      $titles=['dashboard'=>'Dashboard','residents'=>'Sakinler','dues'=>'Aidat Yönetimi','expenses'=>'Giderler','announcements'=>'Duyurular','events'=>'Etkinlikler'];
